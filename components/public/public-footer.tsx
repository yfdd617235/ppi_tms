...
export default function PublicFooter() {
  ...
  return (
    <footer id="footer" className="bg-black text-white pt-20 pb-2 px-6 lg:px-20 2xl:px-60">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start text-left">
        ...
        <div className="flex flex-col items-start md:items-center px-4">
          <div className="flex flex-col space-y-2 text-green-200">
            <h3 className="text-white font-bold text-lg md:text-xl pb-3">{t('cards.title')}</h3>
            <Link href="/consulting" className="hover:text-green-500 transition-colors">{t('cards.title1')}</Link>
            <Link href="/projects-bank" className="hover:text-green-500 transition-colors">{t('cards.title2')}</Link>
            <Link href="/education" className="hover:text-green-500 transition-colors">{t('cards.title3')}</Link>
            <Link href="/trading" className="hover:text-green-500 transition-colors">{t('cards.title4')}</Link>
          </div>
        </div>

        {/* Contact */}
        <div className="flex flex-col items-start md:items-end space-y-3 px-4 text-sm md:text-base">
          <h5 className="font-bold text-white mb-1 text-lg md:text-xl">{t('footer.contactTitle')}</h5>
      ...
      <div className="mt-20">
        <h3 className="text-gray-500 font-bold text-sm">{t('footer.centralTitle')}</h3>
        <p className="text-gray-500 text-sm">{t('footer.centralText')}</p>
      </div>
