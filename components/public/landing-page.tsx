...
export default function LandingPage() {
  return (
    <div className="flex flex-col text-sm md:text-base lg:text-lg leading-relaxed">
        ...
        <div className="w-full max-w-6xl flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <p className="text-justify">
              ...
              <span className="font-bold text-green-900">—Evaluation, Planning, Execution, and Control—</span>{' '}
      ...
      {/* About Us */}
      <motion.div
        className="py-10 md:py-20 bg-linear-to-br from-[#DDEEE0] to-white text-black px-6 lg:px-20 2xl:px-60"
      ...
      {/* Global Presence */}
      <motion.div
        className="py-10 md:py-20 bg-linear-to-tl from-[#DDEEE0] to-white flex flex-col items-center text-black px-6 text-center"
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 1 }}
        viewport={{ once: true }}
