...
export default async function AdminEstadoCuentaPage({
  ...
  const [{ data: companies }, { data: ingresos }, { data: egresos }] = await Promise.all([
    ...
    supabase
      ...
      .select('id, verificado_at, valor_neto, comision_ppi, impuesto_4x1000, descripcion, company_id, companies(razon_social), accounts(nombre)')
  ...
  type Entry = {
    ...
    tarifa: number; impuesto: number; company_id: string
  }
